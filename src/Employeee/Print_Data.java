...
class Print_Data implements ActionListener{
    ...
    String emp_id,name,department,address,phone,email,education,post,age,dob,aadhar;
    JButton b1,b2;
    ImageIcon icon;
    ...
    Print_Data(String e_id){
        try{
            conn con = new conn();
            String str = "select * from employee where empname = '"+e_id+"'";
        ...
        id9.add(aid2);
//
        id3= new JLabel("Department:");
        id3.setBounds(50,220,150,30);
        id3.setFont(new Font("serif",Font.BOLD,20));
        id9.add(id3);

        aid3= new JLabel(department);
