...
public class Remove_Department implements ActionListener {
JFrame f;
    JTextField t;
    ...
    Remove_Department(){
        f=new JFrame("Remove Department");
  ...
  //      l4.setVisible(false);
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        if(ae.getSource()==b){
            try{
                conn con = new conn();
                String str = "select depname from department where id ='"+t.getText()+"' ";
        ...
        if(ae.getSource()==b1){
            try{
                conn con = new conn();
                String str = "delete from department where id = '"+t.getText()+"'";
