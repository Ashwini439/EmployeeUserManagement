...
class Add_Employee implements ActionListener{
    ...
    JTextField t,t1,t2,t3,t4,t5,t6,t8,t9,t10,t11,t12,t13;
    JButton b,b1,b2,b3;
    JComboBox t7;
    ...
    ResultSet rs;
			...
			t7.addItem(rs.getString("depname"));
			t7.setVisible(true);
                        }
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        String a = t1.getText();
        String c = t3.getText();
        String g = t7.getItemAt(t7.getSelectedIndex()).toString();;

    
          if(ae.getSource() == b){
            try{
                conn cc = new conn();
                String q = "insert into employee (empname,age,depname) values('"+a+"','"+c+"','"+g+"')";
